...
<html lang="en-US">
	...
	<title>Thread</title>
	<meta charset="utf-8">
	<meta name="description" content="News and discussions about shows playing on NBC.">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<section id="main_section"><!-- meet of the website-->
		<article class="trendingThreads trending threads topics nbc article">
			<header><p class="channelHeader">Popular on the NBC forum</p></header>
			<div class="div trendingThreads trending threads topics nbc">
			<? loadTrendingThreads();?>
			</div>
		</article>
	...
	<aside id="trendingNow" class="sideRight side_news twitter feed trendingNow general"><!-- id was side_news-->
		<h3>NBC</h3>
		<div class="ad">
		<a class="twitter-timeline"  href="https://twitter.com/nbc" data-widget-id="570625160143585280">Tweets by @nbc</a>
