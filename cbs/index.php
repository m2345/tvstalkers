...
<html lang="en-US">
	...
	<title>Thread</title>
	<meta charset="utf-8">
	<meta name="description" content="News and discussions about shows playing on CBS.">
	...
	<script src="http://tvstalkers.com/includes/analyticstracking.js"></script>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<section id="main_section"><!-- meet of the website-->
		<article class="trendingThreads trending threads topics cbs article">
			<header><p class="channelHeader">Popular on the CBS forum</p></header>
			<div class="div trendingThreads trending threads topics cbs">
			<? loadTrendingThreads();?>
			</div>
		</article>
	...
	<aside id="trendingNow" class="sideRight side_news twitter feed trendingNow general"><!-- id was side_news-->
		<h3>CBS</h3>
		<div class="twitter">
	    <a class="twitter-timeline" href="https://twitter.com/CBS" data-widget-id="570624974621138944">Tweets by @CBS</a>
